    ...
    <div class="px-4">
      <div class="border p-4 my-4 flex flex-col md:w-1/2 rounded">
        ...
        <div class="action mt-5 flex">
          <input v-model="store.config.allSearch" type="checkbox" />
        </div>
      </div>
      ...
      <div class="border p-4 my-4 flex flex-col md:w-1/2 rounded">
        <div>是否允许匿名聊天</div>
        <div class="action mt-5 flex">
          <input v-model="store.config.allAnonChat" type="checkbox" />
        </div>
      </div>
      ...
      <div class="border p-4 my-4 flex flex-col md:w-1/2 rounded">
        <div>添加好友验证信息</div>
        <div class="action mt-5 flex">
          <select v-model="store.config.addFriendMode">
        ...
        <div class="action mt-5 flex" v-if="store.config.addFriendMode > 1">
          <input
            v-model="store.config.addFriendQuestion"
            class="p-1 m-1 border"
            placeholder="问题"
          />
          <input
            v-model="store.config.addFriendAnswer"
            class="p-1 m-1 border"
            placeholder="答案"
          />
        </div>
      ...
      <div class="border p-4 my-4 flex flex-col md:w-1/2 rounded">
        ...
        <div class="action mt-5 flex">
          <input
            v-model="store.config.allMultipleAccountsLogin"
            type="checkbox"
          />
        </div>
      </div>
