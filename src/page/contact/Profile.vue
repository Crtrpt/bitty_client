<template>
  <div class="container mx-auto">
    ...
    <div class="w-full mx-auto flex justify-center items-center">
      <div class="ml-20 flex flex-col">
        <div class="flex items-center">
          <img class="w-20 shadow-xl rounded-full" :src="data.avatar" />
    ...
    <div class="px-4 flex">
      <div
        class="px-4 py-2 border rounded bg-blue-500 text-white cursor-pointer hover:bg-blue-600"
      ...
      <div
        class="px-4 py-2 border rounded text-blue-500 mx-2 cursor-pointer hover:text-red-500"
        @click="remove"
      >
        删除
      </div>
